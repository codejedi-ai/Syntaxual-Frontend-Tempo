  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-purple-950/30 to-black text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        {/* Reset Password Form */}
        {showResetForm ? (
          <div className="space-y-4 bg-purple-900/20 p-6 rounded-lg border border-purple-500/20">
            {resetSuccess ? (
              <div className="text-center space-y-4">
                <p className="text-green-400">Password reset email sent! Check your inbox.</p>
                <Button 
                  className="w-full bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:from-fuchsia-500 hover:to-pink-500 text-white"
                  onClick={() => {
              ...
              <>
                ...
                <div className="flex space-x-2">
                  <Button 
                    ...
                    className="flex-1 bg-gradient-to-r from-fuchsia-600 to-pink-600 hover:from-fuchsia-500 hover:to-pink-500 text-white disabled:opacity-50"
                  >
          ...
          <div className="space-y-6 bg-purple-900/20 p-6 rounded-lg border border-purple-500/20">
            ...
            <form onSubmit={form.handleSubmit(handleEmailLogin)} className="space-y-4">
              ...
              <Button 
                type="button" 
                variant="link" 
                className="w-full p-0 h-auto text-sm text-fuchsia-400 hover:text-fuchsia-300"
